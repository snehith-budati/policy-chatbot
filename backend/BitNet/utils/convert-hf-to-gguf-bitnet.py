...
import gguf
try:
    gguf.MODEL_TENSORS[gguf.MODEL_ARCH.LLAMA].extend([gguf.MODEL_TENSOR.FFN_SUB_NORM, gguf.MODEL_TENSOR.ATTN_SUB_NORM])
except Exception:
    pass
...
@Model.register("LLaMAForCausalLM", "LlamaForCausalLM", "MistralForCausalLM", "MixtralForCausalLM", "BitNetForCausalLM")
    ...
    def set_vocab(self):
        try:
            ...
            try:
                ...
                # fallback for missing tokenizer.model
                self._set_vocab_gpt2()
    def set_gguf_parameters(self):
        super().set_gguf_parameters()
